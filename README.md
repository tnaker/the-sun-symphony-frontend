...
**🌐 Live Demo:** [https://the-sun-symphony-frontend.vercel.app/](https://the-sun-symphony-frontend.vercel.app/)
...
Hệ thống đã hoàn thiện các Use Cases sau (Tuần 1 - Tuần 6):
...
6.  **Protected Admin Dashboard:** 
    * Trang Đăng nhập (Login) giả lập bảo mật.
    * Bảng quản lý bài hát (Tracks Table) với đầy đủ tính năng CRUD UI và phân loại trạng thái.

## 🛠 Hướng dẫn kiểm thử (Testing)
Truy cập vào Live Demo hoặc chạy local để xem ứng dụng.
Để truy cập vào Route `/admin`, hệ thống sẽ yêu cầu đăng nhập. 
* **Tài khoản test:** `admin@thesunsymphony.com` 
* **Mật khẩu:** `123456`
